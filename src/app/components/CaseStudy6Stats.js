    ...
    <div className="flex flex-col md:flex-row w-full bg-gray-100 min-h-[500px]">
      ...
      <div className="w-full md:w-[45%] bg-zinc-900 p-6 md:p-12 flex flex-col justify-center">
        <div className="space-y-6">
          <div>
            <div className="text-white text-3xl md:text-5xl lg:text-[65px] font-semibold mb-1">90+</div>
            <div className="text-white text-[22px]">App Screens</div>
          </div>
          <br />

          <div>
            <div className="text-white text-3xl md:text-5xl lg:text-[65px] font-semibold font-serif mb-1">⭐</div>
            <div className="text-white text-[22px]">Improved Ratings</div>
          </div>
          <br />

          <div>
            <div className="text-white text-3xl md:text-5xl lg:text-[65px] font-semibold font-serif mb-1">🏆</div>
            <div className="text-white text-[22px]">Award Winner</div>
          </div>
        </div>
      </div>
...
export default CaseStudy6Stats;
