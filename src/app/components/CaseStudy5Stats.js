      ...
      <div className="w-full md:w-[45%] bg-zinc-900 p-6 md:p-12 flex flex-col justify-center">
        <div className="space-y-6">
          <div>
            ...
            <div className="text-white text-[22px]">Top Free Games</div>
          </div>
          <br />

          <div>
            <div className="text-white text-3xl md:text-5xl lg:text-[65px] font-semibold font-serif mb-1">500K+</div>
            <div className="text-white text-[22px]">Installs/Day</div>
          </div>
          <br />

          <div>
            <div className="text-white text-3xl md:text-5xl lg:text-[65px] font-semibold font-serif mb-1">Global</div>
            <div className="text-white text-[22px]">Expansion</div>
          </div>
        </div>
      </div>
...
export default CaseStudy5Stats;
